    ...
    <div>
      <div className={styles.container}>
        ...
        <div className={`${styles.buttons} ${styles.section}`}>
          <a href="https://souteze.fotbal.cz/turnaje/hlavni/bbcd5c4b-ef68-4f1f-ab1a-881c1e9a303c"
             className={styles.buttons__link} target="_blank" rel="noreferrer">
            Pohár OFS - rozlosování a výsledky
          </a>
          <a href="https://is.fotbal.cz/souteze/detail-souteze.aspx?req=9767b870-a9eb-4444-bec0-01acaae098c9"
             className={styles.buttons__link} target="_blank" rel="noreferrer">
            OKRESNÍ PŘEBOR - rozlosování a výsledky
          </a>
          <a href="https://is.fotbal.cz/souteze/tabulky-souteze.aspx?req=9767b870-a9eb-4444-bec0-01acaae098c9"
             className={styles.buttons__link} target="_blank" rel="noreferrer">
        ...
        <div className={`${styles.club} ${styles.section}`} id="klub">
          ...
          <div className={styles.club__container}>
            ...
            <iframe className={styles.club__map}
